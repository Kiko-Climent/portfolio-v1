      ...
      {showLoader && (
        ...
        >
          ...
          >
            ...
            <text className="orbit-text uppercase text-[clamp(1.0625rem,1.75vw,1.3125rem)] font-semibold transition-opacity duration-700" style={{ opacity: 0, letterSpacing: '0.18em' }}>
